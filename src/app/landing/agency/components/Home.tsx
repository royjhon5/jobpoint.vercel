    ...
    >
      <div className="relative grid grid-cols-1 items-center xl:grid-cols-5">
        <div className="relative z-10 order-2 -mt-24 p-6 xl:order-none xl:col-span-2 xl:-me-24 xl:mt-0 xl:p-0">
          <div className="mx-auto max-w-2xl rounded-xl bg-default-100 dark:bg-default-50 xl:me-0 xl:ms-auto">
            <div className="p-6">
              <Swiper
                speed={1000}
                spaceBetween={10}
                  ...
                  return (
                    <SwiperSlide key={idx}>
                      <div className="flex flex-col items-start justify-end xl:h-full">
                        ...
                        <h2 className="mt-6 text-3xl font-semibold text-[#25229F] md:text-4xl/snug">
                          {item.name}
                        </h2>

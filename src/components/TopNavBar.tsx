                ...
                <li className="menu-item group">
                  <div className="hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                    <Link
                      ...
                      href=""
                    >
                      Demos <LuChevronDown className="ms-2 h-4 w-4" />
                    </Link>
                ...
                <li className="menu-item group">
                  <div className="hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                    <Link
                      ...
                      href=""
                    >
                      Find Jobs <LuChevronDown className="ms-2 h-4 w-4" />
                    </Link>
                    <div className="hs-dropdown-menu z-10 mt-4 hidden min-w-48 rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow-lg transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
                      <ul className="flex flex-col gap-1">
                        {findJobsDemos.map((item, idx) => {
                          return (
                            <li key={idx}>
                              <Link
                                className={cn(
                ...
                <li className="menu-item group">
                  <div className="hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                    <Link
                      ...
                      href=""
                    >
                      Employers <LuChevronDown className="ms-2 h-4 w-4" />
                    </Link>
                    <div className="hs-dropdown-menu z-10 mt-4 hidden min-w-48 rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow-lg transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
                      <ul className="flex flex-col gap-1">
                        {employersDemos.map((item, idx) => {
                          return (
                            <li key={idx}>
                              <Link
                                className={cn(
                ...
                <li className="menu-item group">
                  <div className="hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                    <Link
                      ...
                      href=""
                    >
                      Candidates <LuChevronDown className="ms-2 h-4 w-4" />
                    </Link>
                    <div className="hs-dropdown-menu z-10 mt-4 hidden min-w-48 rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow-lg transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
                      <ul className="flex flex-col gap-1">
                        {candidatesDemos.map((item, idx) => {
                          return (
                            <li key={idx}>
                              <Link
                                className={cn(
                ...
                <li className="menu-item group">
                  <div className="hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                    <Link
                      ...
                      href=""
                    >
                      Blog <LuChevronDown className="ms-2 h-4 w-4" />
                    </Link>
                    <div className="hs-dropdown-menu z-10 mt-4 hidden min-w-48 rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow-lg transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
                      <ul className="flex flex-col gap-1">
                        {blogDemos.map((item, idx) => {
                          return (
                            <li key={idx}>
                              <Link
                                className={cn(
                ...
                <li className="menu-item group">
                  <div className="hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                    <Link
                      ...
                      href=""
                    >
                      Pages <LuChevronDown className="ms-2 h-4 w-4" />
                    </Link>
                    <div className="hs-dropdown-menu z-10 mt-4 hidden min-w-48 rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow-lg transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
                      <ul className="flex flex-col gap-1">
                        {pagesDemos.map((item, idx) => {
                          return (
                            <li key={idx}>
                              <Link
                                className={cn(
      ...
      >
        <div className="flex h-[74px] items-center justify-between border-b border-dashed border-default-200 px-4 transition-all duration-300">
          <Link href="/" className="flex flex-row gap-3 items-center">
            ...
            />
            <p>
              <span className="text-[#332B84] font-bold text-3xl">Job</span>
              <span className="text-[#CC3023] font-bold text-3xl">Point</span>
            </p>
          </Link>
